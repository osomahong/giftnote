...
products:
  - rank: 1
    ...
    category: 쿠키세트
    isEditorPick: true
    reason: 신라호텔 베이커리가 만든 쿠키라 품질이 확실합니다. 고급 선물 박스 포장이 되어 있어 별도 포장 없이 바로 전달 가능합니다.
    giftMessage: '함께해서 감사한 마음, 달콤하게 전해요.'
    evidence:
      - type: community
        source: 블라인드
        text: 직장인 선물 쿠키세트 추천 1위
        value: 월 180회 언급
      - type: trend
        source: 네이버 트렌드
        text: 신라명과 선물세트 검색량 상위
        value: '월 12,000건'
  - rank: 2
    name: 오설록 제주 유채살구향 티 20입
    brand: 오설록
    price: 26400
    source: coupang
    sourceUrl: >-
    ...
    giftMessage: '오후 한 잔의 여유, 감사한 마음과 함께.'
    evidence:
      - type: community
        source: 블라인드
        text: 직장 동료 선물 차 추천 상위
        value: 월 120회 언급
      - type: media
        source: 아모레퍼시픽
        text: 오설록 제주 블렌디드 티 시리즈
        value: 누적 판매 200만개
  - rank: 3
    ...
    giftMessage: 좋은 향기처럼 좋은 하루 보내세요.
    evidence:
      - type: trend
        source: 네이버 트렌드
        text: 모리앤 디퓨저 검색량 상승
  ...
  - rank: 4
    ...
    category: 차
    isEditorPick: false
    reason: 복숭아 향이 가미된 블랙티라 호불호가 적고 인기가 많습니다. 유채살구향과 함께 세트로 드려도 센스 있는 구성이 됩니다.
    giftMessage: 달콤한 오후 시간을 선물합니다.
    evidence:
      - type: youtube
        source: 차 리뷰어
        text: 오설록 인기 티백 맛 비교 리뷰
        value: 조회수 15만
      - type: trend
        source: 네이버 트렌드
        text: 오설록 블랙티 검색량 상위
        value: '월 9,000건'
targets:
  - label: 퇴사하는 동료에게 감사 인사를 전하고 싶은 분
    description: 함께 일한 시간에 대한 고마움을 표현하고 싶을 때가 있습니다. 1만원대 선물은 부담 없이 진심을 전할 수 있는 가격대입니다.
    icon: heart
  - label: 프로젝트 마무리 후 팀원들에게 선물하려는 분
    description: 여러 명에게 한꺼번에 준비해야 할 때 가성비가 중요합니다. 포장이 깔끔한 제품은 개별 포장 수고를 덜어줍니다.
    icon: star
  - label: 연말이나 명절에 직장 선물을 고민하는 분
    description: 직장 선물은 너무 개인적이지 않으면서도 정성이 느껴져야 합니다. 브랜드 인지도가 있는 식품이나 생활용품이 안전한 선택입니다.
    icon: check
editorial:
  eyebrow: Yuna's Note
  body:
    - 직장 선물은 부담과 센스 사이 균형이 핵심입니다. 1만원대지만 포장과 브랜드에서 가격 이상의 인상을 주는 제품을 골랐어요.
    - '블라인드에서 실제 직장인들이 추천하는 제품 위주로 선별했습니다. 쿠키, 차, 디퓨저는 취향 실패 확률이 가장 낮은 카테고리예요.'
    - 1위 신라명과 골든쿠키는 이름값을 하는 제품입니다. 받는 사람이 브랜드를 바로 알아보니 감사 선물로 딱이에요.
  pullQuote:
    text: 1만원대로도 충분히 센스 있는 선물이 됩니다
    cite: Yuna
faqs:
  - question: 직장 동료 감사 선물 1만원대로 뭐가 좋을까요?
    answer: >-
      신라명과 골든쿠키 선물세트(14,500원)는 포장이 고급스러워 가격 대비 만족도가 높습니다. 가벼운 선물은 오설록
      티백(8,250원)도 좋은 선택이에요.
  - question: 직장에서 여러 명에게 줄 선물 추천해주세요
    answer: >-
      오설록 티백(8,250원)이나 모리앤 디퓨저(10,620원)는 개당 만원 내외라 여러 개를 준비하기에 부담이 적습니다. 둘 다 개별
      포장이 되어 있어 편리해요.
  - question: 디퓨저를 선물로 줘도 괜찮을까요?
    answer: >-
      디퓨저는 남녀 구분 없이 사용 가능하고, 사무실 책상에 두기에도 적합해서 직장 선물로 인기가 많습니다. 향이 강하지 않은 제품을
      고르는 것이 포인트예요.
---

직장 동료에게 감사 인사를 전하는 선물 큐레이션입니다. 1만원대 예산으로 센스와 품격을 모두 챙길 수 있는 아이템을 엄선했습니다.
